...
namespace ApplicationOrigin.Test
{
    ...
    public class UsersDbServicesTest
    {
        ...
        public void GetUsers_InputArgument_ReturnValue()
        {
            ...
            var result = repository.CheckNewUser(new User { Id = 1, FirstName = "Максим", LastName = "Баканов", BirthYear = 1998, Login = "makshfh", Password = "batlenaxhdh", Role = "Administrator", Culture = "en" });
